...
mongoose.connect('mongodb+srv://1001:gamerbabo123@cluster0.3ye9b.mongodb.net/backupsanta?retryWrites=true&w=majority', {useNewUrlParser: true, useUnifiedTopology: true});// Mongo connect bağlantısı.
const Database = require("./models/role.js");
// Yashinu tarafından kodlanmıştır.

client.on("ready", async () => {
  client.user.setPresence({ activity: { name: "S'anta" }, status: "idle" });
